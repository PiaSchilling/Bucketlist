...
public class ListManager {
     ...
     */
    public void updateEventlistName(String eventlistNameOld, String eventlistNameNew){
        List<Eventlist> temp = this.eventlists.stream()
                .filter(eventlist -> eventlist.getName().equals(eventlistNameOld))
                .collect(Collectors.toList());
        Eventlist eventlist = temp.get(0);
        eventlist.updateEventlistName(eventlistNameNew);
